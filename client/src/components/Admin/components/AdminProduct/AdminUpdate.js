          ...
          ? SelectList.map((item) => (
              <div className="select-type" key={item.property}>
                <select
                  ...
                  defaultValue={detailProduct ? detailProduct[item.property] : ""}
                  onChange={(e) => handleOptionChange(item.property, e.target.value)}
                >
                  {detailProduct && !detailProduct[item.property] && (
