...
export default function FilterMenu() {
  ...
  useEffect(() => {
    if (chooseSelectItem) {
      setValue("name", chooseSelectItem.name);
      setValue("property", chooseSelectItem.property);
    }
  }, [chooseSelectItem]);
          ...
          >
            ...
            >
              <input
                {...register("name")}
                placeholder="Name ... "
                defaultValue={chooseSelectItem ? chooseSelectItem.name : ""}
              />
              <input
                {...register("property")}
                placeholder="Property ..."
                defaultValue={chooseSelectItem ? chooseSelectItem.property : ""}
              />
